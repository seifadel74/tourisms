...
import { Heart, Shield, Star, Users, Globe, Award, MapPin, Phone, Mail, Clock } from 'lucide-react';
          ...
          <div className="contact-info">
            {[
              ...
              },
              {
                ...
                value: t('about.contact.phone.value'),
                href: `tel:${t('about.contact.phone.value')}`,
              },
              {
                icon: Mail,
                title: t('about.contact.email.title'),
                value: t('about.contact.email.value'),
                href: `mailto:${t('about.contact.email.value')}`,
              },
              {
                icon: Clock,
                title: t('about.contact.hours.title'),
                value: t('about.contact.hours.value'),
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
